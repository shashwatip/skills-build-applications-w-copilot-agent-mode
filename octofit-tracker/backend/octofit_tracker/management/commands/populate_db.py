...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        print("Team 1 members:", [user.username for user in team1.members.all()])
        print("Team 2 members:", [user.username for user in team2.members.all()])
        ...
        for activity in activities:
            print(activity.activity_type, activity.duration)
        ...
        for entry in leaderboard_entries:
            print(entry.user.username, entry.score)
        ...
        for workout in workouts:
            print(workout.name, workout.description)
